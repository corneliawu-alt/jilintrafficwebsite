  ...
  },
  {
    ...
    subCategories: [
      ...
      },
      {
        id: '3-3',
        title: '3-3 交通服務及導護規劃',
        content: '交通服務及導護的規劃與管理。建立完善的志工體系，每日安排教師、保全及志工於重點路口執勤。',
        details: ['導護輪值表透明化', '志工裝備定期檢查', '導護安全講習課程']
      },
      {
        id: '3-4',
      ...
      },
      {
        ...
        content: '規劃家長接送區與愛心服務站，且能鼓勵學生步行。設置「愛心商店」作為緊急避難點，並推廣「健康步行」活動。',
        details: ['友善步道系統串聯', '愛心服務站地圖', '步行上下學點數獎勵']
      }
    ]
  },
  {
